...
public record class StackTestReportGasConcentration : BaseStackTestReport
{
    // Operating data
    ...
    public List<GasConcentrationTestRun> TestRuns { get; set; } = new List<GasConcentrationTestRun>();
